...
const beneficiaries: Beneficiary[] = [
  { name: 'UAB Paysera LT', identifier: 'EVP3710002583421', amount: '€728.17', status: 'Paid Out', statusVariant: 'success', description: 'Platform fee (50%)', avatarColor: 'bg-surface-action-primary-initial', initials: 'PL' },
  { name: 'John Smith', identifier: 'PSR-45892', amount: '€583.34', status: 'Paid Out', statusVariant: 'success', description: 'Service provider (40%)', avatarColor: 'bg-surface-success-primary-initial', initials: 'JS' },
  { name: 'Tax Authority', identifier: 'EVP3710001100023', amount: '€145.83', status: 'Paid Out', statusVariant: 'success', description: 'Tax withholding (10%)', avatarColor: 'bg-surface-warning-primary-initial', initials: 'TA' },
];
...
export default function AdminPaymentDetailsSettled() {
    ...
    <div className="min-h-screen bg-background-neutral-primary-initial">
      <div className="max-w-screen-lg mx-auto p-8">
        ...
        <div className="flex items-center justify-between mt-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            <Button label="Refund" variant="critical" onClick={() => setShowRefundModal(true)} />
          </div>
        </div>
      ...
      <Modal
        ...
        description="This will reverse all distributions."
        size="md"
        footer={
          <>
